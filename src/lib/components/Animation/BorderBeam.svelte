<script lang="ts">
	...
	export let colorFrom = '#FFD700'; // Gold
	export let colorTo = '#DAA520'; // Goldenrod
	export let delay = 0;
...
<div
	...
	class={cn(
		'pointer-events-none absolute inset-[0] rounded-[inherit] antialiased [border:calc(var(--border-width)*1px)_solid_transparent]',
